...
const OurMenu = () => {
  ...
  return (
    <div className={`bg-no-repeat bg-cover bg-center relative z-[-2] ourmenu py-16`} 
    ...
    <div className="absolute inset-0 bg-black opacity-80 z-[-1] h-[800px]"></div>
       ...
       <div className="container mx-auto flex justify-center items-center mt-12 md:mt-6">
            ...
            <div className="text-[#fff]">
                ...
                <p className="pr-4">Craving something delicious? Explore our curated selection of local eateries and popular food delivery services. From mouthwatering meals to delightful desserts, discover a variety of options to satisfy your cravings. Order now and treat yourself to a delightful dining experience!</p>
                <button
                onClick={() => alert("HI")}
                className=" text-[#fff] font-bold uppercase border-b-900 border-b rounded-bl rounded-br border-white pb-3 mt-5 z-1 cursor-pointer" 
                >
